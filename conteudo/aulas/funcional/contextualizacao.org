...
- Alan \alert{Turing}, Alonzo \alert{Church}, Stephen \alert{Kleene}, Emil \alert{Post}, etc

#+Latex: \vfill

Formalização da noção de algoritmo \rightarrow \alert{Método Efetivo}
...
1920
- *Moses Schönfinkel* \rightarrow \alert{Teoria de Funções} \\
