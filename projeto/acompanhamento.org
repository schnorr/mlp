...
Existem dois grupos com apenas um membro:
...
| One Man Army                  |        1 |
| get.sh*t.done                 |        2 |
| My Little Frogger Haters      |        2 |
| Cowboy Value                  |        3 |
| Furogga                       |        3 |
| GirlsRule                     |        3 |
| Monstros da Louca Programação |        3 |
| Programadores Anônimos        |        3 |
| Scipio Project                |        3 |
| teletypewriters               |        3 |

Sugere-se portanto aos grupos /Han Solo/ e /One Man Army/ a integrar as
equipes /get.sh*t.done/ e /My Little Frogger Haters/, que são grupos com
apenas dois membros.

** Grupo vs Linguagens

A tabela abaixo mostra a definição das linguagens após sorteio
naqueles cenários onde os grupos selecionaram demasiadamente uma
linguagem. O código de análise encontra-se abaixo.
