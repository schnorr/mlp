...
| Funcional  | ML: Introdução, tipos de dados primitivos e estruturados, funções.                           | LAB   | Anúncio      |
| Funcional  | ML: Funções compostas, recursividade, pattern matching, polimorfismo e sobrecarga.           | LAB   |              |
| Funcional  | ML: Tipos definidos pelo usuário e tipos estruturados de dados, tipos polimórficos.          | LAB   | Def. Grupos  |
| Lógico     | Prolog: Modelo de prog. em lógica; caract. do modelo; fundamentos de lógica; semântica.      | LAB   |              |
| Lógico     | Prolog: Aritmética, recursividade, estrutura de um programa, I/O.                            | LAB   |              |
| Lógico     | Prolog: Listas, estruturas, base de dados, gramáticas DCG.                                   | LAB   | Inicial      |
...
| OO         | Orientação a Objeto: classes, atributos e métodos; encapsulamento; proteção; construtores    | LAB   |              |
| OO         | Orientação a Objeto: Herança, polimorfismo                                                   | LAB   |              |
| OO         | Orientação a Objeto: Polimorfismo paramétrico; coleções; reflexão                            | LAB   |              |
...
| Extra      | Programação concorrente                                                                      | LAB   |              |
...
|  4 | 2018-08-20 | LAB   | Funcional  | ML: Introdução, tipos de dados primitivos e estruturados, funções.                           | Anúncio      |
|  5 | 2018-08-22 | LAB   | Funcional  | ML: Funções compostas, recursividade, pattern matching, polimorfismo e sobrecarga.           |              |
|  6 | 2018-08-27 | LAB   | Funcional  | ML: Tipos definidos pelo usuário e tipos estruturados de dados, tipos polimórficos.          | Def. Grupos  |
|  7 | 2018-08-29 | LAB   | Lógico     | Prolog: Modelo de prog. em lógica; caract. do modelo; fundamentos de lógica; semântica.      |              |
|  8 | 2018-09-03 | LAB   | Lógico     | Prolog: Aritmética, recursividade, estrutura de um programa, I/O.                            |              |
|  9 | 2018-09-05 | LAB   | Lógico     | Prolog: Listas, estruturas, base de dados, gramáticas DCG.                                   | Inicial      |
...
| 13 | 2018-09-19 |       | Imperativo | Tipos de Dados: representação, equivalência, compatibilidade, conversão e checagem de tipos. |              |
| 14 | 2018-10-01 |       |            | PA                                                                                           |              |
...
| 19 | 2018-10-24 | LAB   | OO         | Orientação a Objeto: classes, atributos e métodos; encapsulamento; proteção; construtores    |              |
| 20 | 2018-10-29 | LAB   | OO         | Orientação a Objeto: Herança, polimorfismo                                                   |              |
| 21 | 2018-10-31 | LAB   | OO         | Orientação a Objeto: Polimorfismo paramétrico; coleções; reflexão                            |              |
...
| 24 | 2018-11-12 | LAB   | Extra      | Programação concorrente                                                                      |              |
